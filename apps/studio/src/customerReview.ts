...
<style>
:root{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#20251d;background:#f3f4ef}*{box-sizing:border-box}body{margin:0}button,textarea{font:inherit}header{padding:40px clamp(18px,5vw,72px) 28px;background:#182014;color:#f4f7ee}header small{color:#b9d478;font-weight:700;letter-spacing:.08em}h1{max-width:800px;margin:8px 0 6px;font-size:clamp(30px,6vw,58px);letter-spacing:-.055em;line-height:1}header p{margin:0;color:#a9b2a3}.grid{display:grid;max-width:1240px;margin:auto;padding:24px clamp(14px,4vw,48px) 120px;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:12px}.card{overflow:hidden;border:1px solid #d9ddd3;border-radius:16px;background:#fff}.media{display:grid;aspect-ratio:1;place-items:center;background-color:#e9ebe5;background-image:linear-gradient(45deg,#dde0d8 25%,transparent 25%),linear-gradient(-45deg,#dde0d8 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#dde0d8 75%),linear-gradient(-45deg,transparent 75%,#dde0d8 75%);background-size:20px 20px;background-position:0 0,0 10px,10px -10px,-10px 0}.media img,.media video{display:block;width:100%;height:100%;object-fit:contain}.body{padding:14px}.body h2{margin:0 0 10px;font-size:16px}.choice{display:flex;gap:6px}.choice button{min-height:38px;flex:1;border:1px solid #d9ddd3;border-radius:9px;background:#f6f7f3;color:#5e6758;cursor:pointer}.choice button.approved.active{border-color:#7fa23d;background:#edf4df;color:#52751f}.choice button.changes.active{border-color:#ca8453;background:#fff0e5;color:#a25121}textarea{width:100%;min-height:76px;margin-top:8px;padding:9px;border:1px solid #d9ddd3;border-radius:9px;resize:vertical}.submit{position:fixed;right:0;bottom:0;left:0;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px clamp(16px,5vw,72px);border-top:1px solid #d9ddd3;background:rgba(255,255,255,.94);backdrop-filter:blur(12px)}.submit span{color:#6c7468;font-size:13px}.submit button{min-height:42px;padding:0 18px;border:0;border-radius:10px;background:#9fbe5b;color:#17200f;font-weight:700;cursor:pointer}.submit button:disabled{opacity:.4;cursor:not-allowed}.error{color:#a25121!important}@media(max-width:620px){.grid{grid-template-columns:1fr}.submit{align-items:stretch;flex-direction:column}.submit button{width:100%}}
