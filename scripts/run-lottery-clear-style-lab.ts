...
const realPhotoPaths = [
  "/Users/lajunkai/Pictures/lottery/微信图片_20260818000646_22_17.jpg",
  "/Users/lajunkai/Pictures/lottery/微信图片_20260818000706_23_17.jpg",
  "/Users/lajunkai/Pictures/lottery/微信图片_20260818001204_26_17.jpg",
  "/Users/lajunkai/Pictures/lottery/微信图片_20260818001103_24_17.jpg",
];
...
const projectId = "project-lottery-clear-lively-v1";
const states = {
  sitting: {
    label: "坐着",
...
const selectedStateImages = {
  sitting: "/api/media/6e5cb0b1-1534-4a22-b5a8-d768e9f7092c.png",
  lying: "/api/media/be091f92-7d26-4e93-90ce-562eb2df95e0.png",
  sleeping: "/api/media/4bc36409-1818-44e0-a5ea-d7f06f839c08.png",
  belly: "/api/media/a6db7072-a949-4faf-af69-71373e6fe901.png",
} as const;
const transitions = {
...
if (mode === "image" || mode === "project-image") {
  const stateKey = (process.argv[3] ?? "sitting") as keyof typeof states;
  const state = states[stateKey];
  if (!state) throw new Error(`Unknown state: ${String(stateKey)}`);
  const submitted = await submitStateDraftJob({
    jobId: randomUUID(),
    trigger: {
      projectId: mode === "image" ? `style-lab:${profile.id}` : projectId,
      entityType: "state",
  ...
  const key = process.argv[3] as keyof typeof transitions;
